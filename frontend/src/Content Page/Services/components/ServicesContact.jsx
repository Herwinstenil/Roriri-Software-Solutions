...
function ServicesContact() {
    ...
    return (
        <Motion.section id="servicescontact"
            className="py-16 md:py-24 bg-gray-50 mx-auto my-12 max-w-screen-xl px-4 italic"
            initial="hidden"
            whileInView="visible"
        ...
        >
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between" id='contact'>
                ...
                <div className="lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0">
                    <p className="text-sm text-gray-600 uppercase tracking-wider mb-2">Contact Us</p>
                    ...
                    <div className="flex items-center justify-center lg:justify-start mb-8">
                        <img src={LogoWeb} alt="Roriri Logo"
                            className="h-15 w-40 mr-3"
                        />
                    </div>

                    <h3 className="text-xl font-semibold text-gray-900 mb-4">Follow Us:</h3>
                    <Motion.div className="flex justify-center lg:justify-start space-x-4">
                        <a href="https://www.facebook.com/RoririSoftwareSolutionsPvtLtd/" target="_blank">
                            <img src={facebook} className="h-12 w-12 hover:scale-110 transition" />
                        </a>
                        <a href="https://www.instagram.com/roriri_it_park/" target="_blank">
                            <img src={instagram} className="h-12 w-12 hover:scale-110 transition" />
                        </a>
                        <a href="https://www.linkedin.com/company/roriri-software-solutions-pvt-ltd/" target="_blank">
                            <img src={linkedin} className="h-12 w-12 hover:scale-110 transition" />
                        </a>
                        <a href="https://www.youtube.com/@Roriri_soft" target="_blank">
                            <img src={youtube} className="h-12 w-12 hover:scale-110 transition" />
                        </a>
                    </Motion.div>
                </div>
