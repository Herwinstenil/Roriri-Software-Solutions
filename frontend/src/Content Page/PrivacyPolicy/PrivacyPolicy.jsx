      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl bg-gray-800 rounded-lg shadow-xl p-8 sm:p-10 lg:p-12">
          ...
          >
            ...
            <h3 className="text-xl font-medium text-gray-300 mb-2">Personal Information:</h3>
          ...
          >
            ...
            <p className="text-gray-400">
              For any inquiries, concerns, or requests related to this Privacy Policy, please contact us at: Email: <a href="mailto:privacy@roririsoft.com" className="text-blue-400 hover:underline">privacy@roririsoft.com</a>
            </p>
