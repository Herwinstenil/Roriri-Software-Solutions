...
const Internship = () => {
  return (
    <>
      <div className='italic flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900'>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-3 px-8  ">
          <div className=" flex flex-col justify-center text-center px-3 lg:text-left">
            ...
            <p className="text-base sm:text-lg text-gray-400 mb-8 max-w-lg lg:max-w-none mx-auto lg:mx-0">
        ...
        <div style={{ height: '600px', position: 'relative' }} className=''>
          <h1 className='text-center text-white text-5xl font-normal '>Intern <span className='text-green-400'>To</span> Our Employees</h1>
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col justify-center text-center md:text-left p-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-normal leading-tight mb-4 text-white">
                Project Internship
              </h1>
