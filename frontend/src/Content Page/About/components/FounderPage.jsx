...
const FounderProfileSection = () => {
  return (
    <>
      <div className="italic  min-h-screen bg-white flex-col flex gap-10 py-12 px-4 sm:px-6 lg:px-16 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className='text-start flex flex-col gap-5 pl-5'>
          <h1 className='text-6xl font-medium text-blue-800'>Founder</h1>
          <p className='text-3xl text-gray-400'>The visionary force behind RORIRI Soft Tech</p>
        </div>
        <div className="flex flex-col lg:flex-row items-center gap-10 max-w-7xl w-full">
          ...
          <div className="flex flex-col w-full text-center md:text-left">
            ...
            <p className="text-gray-400 text-base sm:text-lg mb-4 w-full">
            ...
            <p className="text-gray-400 text-base sm:text-lg mb-6 w-full">
